    ...
    <AnimatePresence>
      {isOpen && (
        ...
        <motion.div
          ...
          className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-3xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800 relative p-5 space-y-4 z-10"
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button 
              onClick={onClose}
              className="p-1.5 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 rounded-full hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer"
            >
              <X size={16} />
            </button>
          </div>
                  ...
                  >
                    ...
                    {inPlaylist ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-[11px] font-bold rounded-xl shadow-sm transition-all active:scale-95 shrink-0 flex items-center gap-1 cursor-pointer"
                      >
                        <Plus size={13} /> Add
                      </button>
                    )}
          ...
          {!showCreateNew ? (
            <button
              ...
              className="w-full py-2.5 bg-indigo-50 dark:bg-indigo-950/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-600 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800/60 text-xs font-bold rounded-2xl transition-all flex items-center justify-center gap-1.5 cursor-pointer"
            >
            ...
            <form onSubmit={handleCreateAndAdd} className="space-y-2 pt-2 border-t border-gray-100 dark:border-gray-800">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 text-xs font-bold text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 py-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl shadow-md cursor-pointer"
                >
                  Save Playlist
                </button>
              </div>
