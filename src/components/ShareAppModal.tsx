      ...
      {isOpen && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800 relative p-6 space-y-5 z-10"
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button 
                onClick={onClose}
                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-500 hover:text-gray-900 dark:hover:text-white rounded-full transition-colors cursor-pointer"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <button
                ...
                className="p-3 bg-gradient-to-r from-indigo-600 to-violet-600 text-white text-xs font-bold rounded-2xl shadow-md flex items-center justify-center gap-2 active:scale-95 transition-all cursor-pointer"
              >
